...
public final class PropertyReader {
    public Object readPath(String expression, TemplateContext context) {
        ...
        for (final var segment : path.segments()) {
            ...
            current = readProperty(current, segment.name(), segment.optional());
        }
    ...
    private Path parsePath(String expression) {
        ...
        if (trimmedExpression.isBlank()) {
            return new Path("", java.util.List.of());
        }
        ...
        while (index < trimmedExpression.length()) {
            ...
            if (currentCharacter == '.') {
                ...
                if (rootName == null) {
                    ...
                    segments.add(new PathSegment(current.toString(), nextSegmentOptional));
                }
        ...
        return new Path(rootName, java.util.List.copyOf(segments));
    }
